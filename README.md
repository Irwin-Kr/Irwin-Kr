...
* 차량 비교 웹 페이지 : [CarCompareSite](https://github.com/Irwin-Kr/CarCompareSite)
  ...
  2. 사용한 개발 언어<br><br>
     <img src="https://img.shields.io/badge/java-007396?style=plastic&logo=Java&logoColor=white"> <!-- 현재 Oracle측 변호사로부터 메일 회신 후 제거됨 https://github.com/simple-icons/simple-icons/issues/7374 -->
